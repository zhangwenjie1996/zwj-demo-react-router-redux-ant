...
export default class EditorConvertToJSON extends Component {
 ...
 const content = {"entityMap":{},"blocks":[{"key":"637gr","text":"zwjInitialized from content state.","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}]};
    ...
    console.log("contentState",contentState,EditorState.createWithContent(contentState))
  ...
  render() {
    ...
    console.log("999render",contentState,editorState )
    return (
        <div>
      <Editor
