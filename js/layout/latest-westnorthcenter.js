...
export default class WestNorthCenter extends React.Component {
            ...
            <IntlProvider locale={navigator.language} messages={new Context().lang.cust}>
                <XAuthorization page={this.page}>
                    ...
                    <Row gutter={16} style={{ margin: 0 }}>
                        <Col xs={this.content.west.xs} sm={this.content.west.sm} md={this.content.west.md} lg={this.content.west.lg}>{this.props.children[0]}</Col>
                        <Col xs={this.content.east.xs} sm={this.content.east.sm} md={this.content.east.md} lg={this.content.east.lg}>
                            <Row>
                                <Col  >{this.props.children[1]}</Col>
                                <Col >{this.props.children[2]}</Col>
                            </Row>
                        </Col>
                    </Row>
                </XAuthorization>
